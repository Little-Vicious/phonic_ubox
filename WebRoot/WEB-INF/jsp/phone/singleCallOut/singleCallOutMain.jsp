        ...
        <div class="panel panel-default">
          <form action="${pageContext.request.contextPath }/user/querUsers.action" method="post">
            ...
            <div class="panel panel-info">
              <div class="panel-heading">单个外呼</div>
            </div>
            <div class="panel-body">
              <table id="dataTable" width="100%">
                ...
                <tr>
                  ...
                  <td width="20%"><input type="text" id="custName">
                    <font color="red">*</font>
                  </td>
                  <td align="right">客户电话：</td>
                  <td width="20%"><input type="text" id="custNumber">
                    <font color="red">*</font>
                  </td>
                ...
                <tr>
                  <td align="center" colspan="6">
                    客户评分录音
                    <input type="button" value="播放" onclick="alert('播放');">
                    <input type="button" value="呼叫" onclick="callOut();">
                  </td>
                </tr>
              </table>
            </div>
