    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="panel panel-default">
          ...
          <form id="dataForm" action="${pageContext.request.contextPath }/oppo/editCustSubmit.do" method="post">
            <input type="hidden" id="contextPath" name="contextPath" value="${pageContext.request.contextPath }">
            <input type="hidden" name="groupNo" value="${oppoGroup.groupNo }">
              ...
              <table width="100%" class="table table-striped table-bordered table-hover">
                <tr>
                  ...
                  <td>
                    ...
                    <input id="custName" type="text" name="custName" value="${oppoGroup.custName }" class="form-control">
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <input id="oppoName" type="text" name="oppoName" value="${oppoGroup.oppoName }" class="form-control">
                  </td>
                  <td>
                    商机类型
                  </td>
                ...
                <tr>
                  ...
                  <td>
                  	<input id="custGroup" type="text" name="custGroup" value="${oppoGroup.custGroup }" class="form-control">
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <input id="custNumber" type="text" name="custNumber" value="${oppoGroup.custNumber }" class="form-control">
                  </td>
                  <td>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <textarea name="oppoState" value="${oppoGroup.oppoState }" class="form-control" rows="3"></textarea>
                  </td>
                  <td>
                    备注
                  </td>
                  <td>
                    <textarea name="comments" value="${oppoGroup.comments }" class="form-control" rows="3"></textarea>
                  </td>
                </tr>
