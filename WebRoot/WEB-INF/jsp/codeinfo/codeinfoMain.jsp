          ...
          <form method="post">
            <div class="panel panel-info">
              <div class="panel-heading">
                ...
                <div style="float: right">
                   <a href="${pageContext.request.contextPath }/codeinfo/editCodeType.do">
            ...
            <div class="panel-body">
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                  <c:forEach items="${listCodeType}" var="type">
                    <tr class="odd gradeX">
                      <td>${type.typeName}</td>
                      <td>
                        <a href="${pageContext.request.contextPath }/codeinfo/editCodeType.do?typeCode=${ type.typeCode }">
                          <i class="fa fa-edit fa-fw"></i>编辑
                        </a>
                        <a href="${pageContext.request.contextPath }/codeinfo/listCodeInfoByType.do?typeCode=${type.typeCode}">
                          <i class="fa fa-plus fa-fw"></i>添加码值
                        </a>
                        <a href="${pageContext.request.contextPath }/codeinfo/deleteCodeType.do?typeCode=${type.typeCode}" onclick="return del(this);">
