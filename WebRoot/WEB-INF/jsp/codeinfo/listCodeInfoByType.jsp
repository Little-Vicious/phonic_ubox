          ...
          <form method="post">
            <div class="panel panel-info">
              <div class="panel-heading">
                ${codetype.typeName } - 码值列表
                <div style="float: right">
                   <a href="${pageContext.request.contextPath }/codeinfo/listCodetypeAll.do">
                   <i class="fa fa-history fa-fw"></i>返回 </a>
                   <a href="${pageContext.request.contextPath }/codeinfo/editCodeInfoByType.do?typeCode=${codetype.typeCode }">
            ...
            <div class="panel-body">
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                  <c:forEach items="${codeinfos}" var="code">
                    <tr class="odd gradeX">
                      <td>${code.codeValue}</td>
                      <td>${code.codeName}</td>
                      <td>
                        <a href="${pageContext.request.contextPath }/codeinfo/editCodeInfoByType.do?typeCode=${ code.typeCode }&&codeValue=${ code.codeValue }">
                          <i class="fa fa-edit fa-fw"></i>编辑
                        </a>
                        <a href="${pageContext.request.contextPath }/codeinfo/deleteCodeInfoById.do?typeCode=${ code.typeCode }&&codeValue=${ code.codeValue }" onclick="return del(this);">
