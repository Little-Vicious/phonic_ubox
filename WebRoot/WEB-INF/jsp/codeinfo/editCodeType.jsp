    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="panel panel-default">
          ...
          <form id="codetypeForm" action="${pageContext.request.contextPath }/codeinfo/editCodeTypeSubmit.do" method="post">
            ...
            <div class="panel-body">
              ...
              <tr>
                  ...
                  <td>
                    <input type="text" name="typeCode" value="${codetype.typeCode }">
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <input type="text" name="typeName" value="${codetype.typeName }">
                  </td>
                </tr>
                <tr>
